...
export const Home: React.FC<HomeProps> = ({ products, onAddToCart, onProductClick }) => {
  ...
  // Update upper bound when products change
  useEffect(() => {
        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="max-w-2xl mx-auto relative">
            ...
            <input
              ...
              className="w-full pl-11 pr-4 py-3 md:py-4 rounded-2xl text-slate-800 shadow-lg focus:outline-none focus:ring-4 focus:ring-brand-500/50"
              value={searchTerm}
